...
| Isaac Sim 6.0.1 的受控體腳本 | ⚠ **未在本 repo 環境驗證**(本機無 GPU)。協定已用假受控體驗過,腳本附驗收清單 |
...
| [38](38-acceptance-and-failure-modes/README.md) | 驗收與失敗形態 | 八項判準在開跑前寫死;負對照在 C2 轉紅而 C6 證明韌體擋了全部 300 個壞框包;兩次 CSV 逐 byte 相同;**步邊界取樣的 2/305 不符**與事件時刻快照;這次踩到的六種失敗形態;換成 Isaac 6.0.1 要驗的七件事 |
