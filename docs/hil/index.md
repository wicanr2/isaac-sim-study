...
- 驗收探針與預先登記:[30 篇](../common/30-acceptance-probes-and-preregistration/README.md)。這一區的十八項判準就是照它的做法寫的。
