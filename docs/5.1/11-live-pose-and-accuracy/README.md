...
本篇延伸閱讀:[04 篇](../../common/04-physics-world/README.md)(teleport vs drive 兩條互斥控制路徑)、[09 篇](../../common/09-physics-simulation-fundamentals/README.md)(reset 語意)、[10 篇](../../common/10-scene-physics-authoring/README.md)(剛體分層——決定你該讀哪一層)。
...
被搬物同理,而且更隱蔽(見 [10 篇 §1](../../common/10-scene-physics-authoring/README.md)):
...
實作上把這三個動作做成模擬器內的指令(掛在一個 UDP 監聽埠上即可,見 [02 篇](../../common/02-python-no-ui/README.md)),就能在不重啟、不開 GUI 的情況下隨時取樣,也能塞進自動化迴圈。
...
它同時也是一個提醒——修法有效不代表你找對了根因,只代表你消掉了其中一個分量。詳見 [10 篇 §4](../../common/10-scene-physics-authoring/README.md) 關於執行期補綁的邊界。
