...
| 8 | [GOAL-2026-09-18-0015](GOAL-2026-09-18-0015.md) | 打滑改善:受控體物理化(扭矩 + 抓地力)、韌體牽引力控制、上位脫困、預防碰撞;Nav2 與模擬同一個時鐘 | [#14](https://github.com/wicanr2/isaac-sim-study/issues/14)–[#18](https://github.com/wicanr2/isaac-sim-study/issues/18)、[#7](https://github.com/wicanr2/isaac-sim-study/issues/7) | 完成(C17 未達標:脫困會動、到 goal 72 mm,但判準要求的「之後不再碰撞」還差 3 步輕觸,不放寬判準) |
