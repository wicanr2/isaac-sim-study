...
延伸閱讀:[05 ROS2 橋接](../../common/05-ros2-bridge/README.md)(bridge 的基本機制與 headless 下的 OmniGraph 陷阱)、[08 5.1 → 6.0.1 遷移風險調查](../../6.0.1/08-migration-5.1-to-6.0-oom-risk/README.md)(場景與記憶體面的遷移)。
...
第 4 項是唯一直接證據。前三項全過而第 4 項失敗,是這套環境常見的失效形狀:extension 起來了、節點也在,但 OmniGraph 沒有 tick(headless 下的成因見 [05 篇](../../common/05-ros2-bridge/README.md))。
