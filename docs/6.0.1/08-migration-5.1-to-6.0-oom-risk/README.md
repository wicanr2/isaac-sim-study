...
| `isaacsim.core.*` 移至 `isaacsim.core.experimental.*` | Core API(PyTorch 底)整組移到新的 Warp 底 Experimental API | 影響 Python 控制腳本相容性,非場景 USD 本身,但常與「場景 6.0 打不開」的報告混在一起 | 同上;本 repo [01 篇](../../common/01-install-and-run-modes/README.md) §3 已記錄 |
