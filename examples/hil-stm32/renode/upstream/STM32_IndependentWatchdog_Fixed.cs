...
{
    public class STM32_IndependentWatchdog_Fixed : BasicDoubleWordPeripheral, IKnownSize
    {
        //TODO: Stop timer on debug stop.
        public STM32_IndependentWatchdog_Fixed(IMachine machine, ulong frequency, bool windowOption = true, uint defaultPrescaler = 0) : base(machine)
        {
