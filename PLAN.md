...
| 35–39 | HIL:STM32(Renode)下位控制器 + Rust 橋接 + Isaac 受控體;39 為 FreeRTOS 版 | `docs/hil/` + `examples/hil-stm32/` | 第一版完成(2026-09-15);Isaac 6.0.1 側同日實測;Renode 四項修正在 fork(未送 PR);GOAL 3 四線完成(2026-09-16,上游 PR #250、renode#1003/#1004);下一階段 `docs/hil/GOAL-2026-09-16-1547.md`(issue #2–#5);決定與結果在 issue #1 |
